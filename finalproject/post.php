...
// It's included by other pages, nevercalled directly.
...
// Print a caption:
echo '<h3>' . $words['new_thread']
 '</h3>';
// Create subject input:
echo '<p><em>' . $words['subject']
. '</em>: <input name="subject" type="text" size="60 maxlength="100" ';
